...
int main()
{
	...
	/* MALLOC 
	- aloca na memória e retorna um ponteiro void* para 
	...
	*/
	...
	- Se não houver memória suficiente para a alocação, 
		um ponteiro nulo é devolvido.
	- Inicializa o vetor com valores zero, para garantir 
		que não tem lixo na memória.
	...
	*/
	...
	/*REALLOC
	- o conteúdo do bloco antigo é copiado no novo bloco,
		e NENHUMA informação é perdida;
	- expande ou encurta memória pré-existente (feita por 
		malloc ou calloc antes);
	- depois de copiar os dados antigos no vetor novo, 
		o realloc dá free no vetor(ponteiro) antigo; 
	- se não houver memória suficiente para a alocação, 
		um ponteiro nulo é devolvido;
	*/
	int *vet2, *vet3;
	...
	for (i=0; i<10; i++) 
	{
		cout << "Valor na posicao " << i <<  " é " << p[i] << endl;
	}
